...
abstract final class WordHuntRouteVisualThemes {
  static const WordHuntRouteVisualTheme ormanYolu = WordHuntRouteVisualTheme(
    ...
    mapTheme: WordHuntRouteMapTheme(
      ...
      pathColor: Color(0xFFF4D98B),
      lockedPathColor: Color(0xFF6E674F),
      nodeColor: Color(0xFF754622),
      lockedNodeColor: Color(0xFF34453A),
      accentColor: Color(0xFFFFD567),
      textColor: Color(0xFFFFF5DE),
      sceneGlowColor: Color(0xFFFFE7A8),
      pathUnderlayColor: Color(0xFF2A1E14),
      nodeShadowColor: Color(0xFF0A160F),
      sceneDepth: 0.58,
    ),
    ...
    backgroundContrast: 1.07,
    backgroundSaturation: 1.06,
    backgroundVignetteColor: Color(0xFF06110A),
    backgroundVignetteStrength: 0.28,
