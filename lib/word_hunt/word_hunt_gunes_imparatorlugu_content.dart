...
abstract final class WordHuntGunesImparatorluguContent {
  ...
  static const List<WordHuntInfoCard> infoCards = <WordHuntInfoCard>[
    WordHuntInfoCard(
      ...
      shortFact: 'Şafak, Güneş henüz doğmadan önce gökyüzünün aydınlanmaya başladığı dönemdir. Güneş ufkun altında olsa bile ışığı atmosferde saçılarak gözümüze ulaşabilir.',
    ),
    WordHuntInfoCard(
      id: 'gunes-info-golge',
      word: 'GÖLGE',
      ...
      shortFact: 'Güneş saatleri, Güneş’in gökyüzündeki görünür hareketi nedeniyle bir göstergenin gölgesinin gün boyunca yer değiştirmesinden yararlanır. Böylece yerel güneş zamanı ölçülebilir.',
    ),
    WordHuntInfoCard(
      ...
      title: 'Yörünge',
      category: 'Astronomi',
      shortFact: 'Yörünge, bir gökcisminin başka bir cisim çevresinde izlediği düzenli yoldur. Gezegenlerin Güneş çevresindeki yörüngeleri elipstir; çoğunda bu elips daireye oldukça yakındır.',
    ),
    WordHuntInfoCard(
      ...
      title: 'Ekinoks',
      category: 'Astronomi',
      shortFact: 'Ekinoks, Güneş’in gökyüzündeki görünür hareketinde gök ekvatorunu geçtiği ve yılda iki kez gerçekleşen andır. Bu tarihlerde gece ve gündüz süreleri birbirine çok yaklaşır; atmosferik kırılma ve Güneş diskinin görünür boyutu nedeniyle tam olarak eşit olmayabilir.',
    ),
    WordHuntInfoCard(
      ...
      title: 'Portik',
      category: 'Mimari',
      shortFact: 'Portik, bir yapının girişinde sütunların taşıdığı üst örtüyle oluşturulan mimari giriş bölümüdür. Antik Yunan ve Roma tapınaklarında cepheyi vurgulayan önemli bir unsur olarak kullanılmıştır.',
    ),
    WordHuntInfoCard(
      ...
      shortFact: 'Takvim, zamanı gün, ay ve yıl gibi birimlere düzenleyen sistemdir. Birçok takvim Dünya’nın dönüşü, Dünya’nın Güneş çevresindeki dolanımı veya Ay’ın döngüleri gibi astronomik hareketlerden yararlanır.',
    ),
  ];
  ...
  static const WordHuntRouteDefinition gunesImparatorlugu =
      ...
      WordHuntLevelDefinition(
        ...
        targetWords: <String>['GÖKYÜZÜ', 'YILDIZ', 'GEZEGEN', 'MEYDAN', 'YÖRÜNGE'],
      ...
      WordHuntLevelDefinition(
        ...
        targetWords: <String>['EKİNOKS', 'AYNA', 'YANSIMA', 'AÇI', 'DENGE', 'ODAK'],
      ...
      WordHuntLevelDefinition(
        ...
        targetWords: <String>['TAPINAK', 'SUNAK', 'BASAMAK', 'KUBBE', 'KUTSAL', 'PORTİK'],
      ...
      WordHuntLevelDefinition(
        ...
        targetWords: <String>['ÇARK', 'TAKVİM', 'DİŞLİ', 'EKSEN', 'DÖNGÜ', 'MEVSİM'],
      ...
      WordHuntLevelDefinition(
        ...
        targetWords: <String>['KRALİYET', 'ARMA', 'SALTANAT', 'MİRAS', 'HÜKÜMDAR', 'SALON'],
      ...
      WordHuntLevelDefinition(
        ...
        targetWords: <String>['GÜNEŞ', 'TAHT', 'UYGARLIK', 'BİRLİK', 'MERKEZ', 'GÖRKEM', 'KÖKEN'],
