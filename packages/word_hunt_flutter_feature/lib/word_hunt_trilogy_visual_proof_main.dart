...
Future<void> main() async {
  ...
  FlutterError.onError = (details) {
    debugPrint(
      '[WORD_HUNT_TRILOGY_PROOF_FLUTTER_ERROR] ' + details.exceptionAsString(),
    );
...
class _ProofScenarioButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final semanticLabel = 'TRILOGY_PROOF_SELECT|' + routeId + '|' + state.slug;
    return Semantics(
      label: semanticLabel,
      button: true,
      child: FilledButton(
  ...
  void didChangeDependencies() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      try {
        ...
        debugPrint('[WORD_HUNT_TRILOGY_PROOF_ERROR] error=' + error.toString());
        debugPrintStack(
