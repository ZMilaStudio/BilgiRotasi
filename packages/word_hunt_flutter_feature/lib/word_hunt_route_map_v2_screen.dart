  ...
  Widget _positionNode({
    ...
    final left =
        (point.dx - centerX)
            ...
            .toDouble();
    final top =
        (point.dy - 39).clamp(4.0, sceneSize.height - boxHeight - 4).toDouble();
...
class _RouteStop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final accent =
        !unlocked && level.type == WordHuntLevelType.normal
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children:
                    labelOnLeft ? <Widget>[label, node] : <Widget>[node, label],
              ),
              SizedBox(
