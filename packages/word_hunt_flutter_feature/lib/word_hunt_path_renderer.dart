...
class WordHuntPathVisualSpec {
  ...
  static const WordHuntPathVisualSpec ancientWaymarks = WordHuntPathVisualSpec(
    id: 'ancient-waymarks',
...
class WordHuntPathPainter extends CustomPainter {
  const WordHuntPathPainter({required this.segments, required this.spec});
  ...
  void _paintSegment(Canvas canvas, WordHuntPathSegment segment, Color color) {
    ...
    switch (spec.family) {
      case WordHuntPathVisualFamily.ancientWaymarks:
        _paintDashed(canvas, start, end, color, roundCaps: true, width: width);
        _paintJoint(canvas, start, color);
        _paintJoint(canvas, end, color);
        break;
      case WordHuntPathVisualFamily.engineeredSegmented:
        _paintDashed(canvas, start, end, color, roundCaps: false, width: width);
