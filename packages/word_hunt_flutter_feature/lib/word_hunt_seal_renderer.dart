          ...
          Positioned(
            ...
            child: Row(
              ...
              children: List<Widget>.generate(3, (index) {
                return Container(
                  key: Key('word_hunt_seal_star_socket_${levelIndex}_$index'),
                  width: 11,
                  height: 11,
...
class _WordHuntSealPainter extends CustomPainter {
  ...
  void _paintCenter(Canvas canvas, Offset center, double radius, Color accent) {
    final centerColor =
        _locked
            ? Color.alphaBlend(
    ...
    switch (spec.finalGeometry) {
      ...
      case WordHuntSealFinalGeometry.celestialMechanism:
        for (var i = 0; i < 8; i++) {
          ...
          final end = center + Offset(math.cos(a), math.sin(a)) * radius * 0.90;
          canvas.drawLine(
            start,
            end,
            Paint()
